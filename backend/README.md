...
## Project Structure
    ...
    ├── testapiautocatalog_113573  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_113573`
...
2. Clone this repo and `cd testapiautocatalog_113573`
